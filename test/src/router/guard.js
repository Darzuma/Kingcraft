...
router.beforeEach((to, from, next) => {
    ...
    if(isPayment){
        ...
        const info = {
            'C4C6A7591124362675F0A231FAAC2153IKJLDW675F0A231FAAC2':{ amount:"3.00", remark:20 },
            '0162EBAFA8E90B4AEB6ECF22AD76E3D9DJKQUWD675F0A231FAC2':{ amount:"15.00", remark:200 }
        }[arr[0]]
